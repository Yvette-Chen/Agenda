...
class AgendaService {
   public:
     ...
     * @return if success, true will be returned
     */
    int createMeeting(const std::string userName, const std::string title,
    ...
    /**
      ...
      */
    void changeEmail(string name, string email);
     ...
     * change user name
     */
    bool changeName(string userName, string name);
